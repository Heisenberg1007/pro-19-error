...
function preload(){
    ...
    player_animation = loadAnimation("player_frame1.png", "player_frame2.png","player_frame3.png","player_frame4.png","player_frame5.png","player_frame6.png","player_frame7.png","player_frame8.png")
}
...
gameover.addImage("gameoverImg",gameOver);
gameover.scale = 0.8;
...
function draw() {
  ...
  if(car1grp.isTouching(player) || car2grp.isTouching(player) || car3grp.isTouching(player)){
    gameState = END;
    player.velocityX = 0;
...
function blueCar(){
  car1 =createSprite(1100,Math.round(random(50, 600)));
  car1.scale =1.5;
  car1.velocityX = -(6 + 2*score/150);
  car1.addAnimation("first car",car1_img);
  car1.setLifetime=170;
  car1grp.add(car1);
}

function yellowCar(){
  car2 =createSprite(1100,Math.round(random(50,600)));
  car2.scale =1.5;
  car2.velocityX = -(6 + 2*score/150);
  car2.addAnimation("second car",car2_img);
  car2.setLifetime=170;
  car2grp.add(car2);
}
function brownCar(){
  car3 =createSprite(1100,Math.round(random(50, 600)));
  car3.scale =1.5;
  car3.velocityX = -(6 + 2*score/150);
  car3.addAnimation("third car",car1_img);
